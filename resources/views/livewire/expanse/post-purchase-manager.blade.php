                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-xs-12 text-right">
                        <div class="d-md-flex justify-content-end">
                            <button type="button" wire:click="postMultiple()" class="btn btn-success" title="Post"
                    ...
                    <tbody>
                        @foreach ($purchases as $purchase)
                            <tr>
                                ...
                                <td class="border-start text-center">{{ $purchase->approved_at }}</td>
                            </tr>
                        @endforeach
                ...
                <form wire:submit.prevent="store">
                    <div class="modal-body">
                        ...
                        <div class="accordion" id="accordionExample">
                            @foreach ($purchasesPostMultiple as $key => $val)
