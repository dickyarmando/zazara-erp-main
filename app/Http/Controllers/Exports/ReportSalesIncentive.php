...
class ReportSalesIncentive extends Controller
{
    public function index(Request $request)
    {
        ...
        if($incentiveDetails){
            ...
            $queryUser = User::where('username', $sales_username)->value('name');
            $incentiveDetails->sales_name = $queryUser ?: null;
            $incentiveAmount = 0;
        }

        return view('livewire.exports.sales-incentive-report', [
