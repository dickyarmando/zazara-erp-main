...
class PayPaymentManager extends Component
{
    ...
    public function render()
    {
        ...
        if (!empty($this->searchKeyword)) {
            $purchaseTax->where('tr_purchase.number', 'like', "%" . $this->searchKeyword . "%")->whereNotNull('tr_purchase.approved_at')->where('tr_purchase.is_payed', '0')->where('tr_purchase.is_status', '1');
            ...
            $purchaseNonTax->where('tr_purchase_non.number', 'like', "%" . $this->searchKeyword . "%")->whereNotNull('tr_purchase_non.approved_at')->where('tr_purchase_non.is_payed', '0')->where('tr_purchase_non.is_status', '1');
